// ─────────────────────────────────────────────────────────────
// js/data.js — ข้อมูลตัวอย่างสำหรับ seed.html เท่านั้น
//
// ⚠️ ตั้งแต่ต่อ Firestore แล้ว หน้าใช้งานจริงทุกหน้า (leave-requests.js ·
//    new-leave-request.js · leave-request-detail.js · leave-types.js) จะไม่อ่าน
//    window.LEAVE_DATA อีกต่อไป — ไฟล์นี้เหลือหน้าที่เดียวคือเป็นข้อมูลตั้งต้นให้
//    js/seed.js เอาไปเขียนลง Firestore ตอนตั้งระบบครั้งเดียว (ดู seed.html)
//
