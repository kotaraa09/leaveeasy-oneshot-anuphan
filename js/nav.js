...
(function () {
  var เมนู = [
    ...
    // ไม่ใส่ "เข้าสู่ระบบ" ตรงนี้ — js/auth.js เป็นคนเติมลิงก์เข้าสู่ระบบ/ออกจากระบบ
    // ลง #navUser ให้เอง ใส่ซ้ำแล้วจะมีลิงก์ชื่อเดียวกัน 2 ตัวจนเทสต์อัตโนมัติเลือกไม่ถูก
  ];
